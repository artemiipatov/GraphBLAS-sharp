...
module Merge =
    let run<'a, 'b when 'a: struct and 'b: struct> (clContext: ClContext) workGroupSize =
                    ...
                    for block in 0 .. workBlockCount - 1 do
                        ...
                        if i < workSize then
                            ...
                            while (r - l > 1) do
                                ...
                                if ans then l <- l + mid else r <- r - mid
                        ...
                        if block < workBlockCount - 1 then
                            ...
                            isEndOfRowBitmap.[resOffset + firstLocalOffset + secondLocalOffset + i] <- 1
            @>
        ...
        fun (processor: MailboxProcessor<_>) (leftMatrix: ClMatrix.CSR<'a>) (rightMatrix: ClMatrix.CSR<'b>) ->
            ...
            let ndRange =
                Range1D.CreateValid((leftMatrix.RowPointers.Length - 1) * workGroupSize, workGroupSize)
