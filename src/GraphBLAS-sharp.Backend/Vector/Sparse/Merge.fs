        ...
        let merge =
            <@
                fun
                    ...
                    (secondSide: int)
                    (sumOfSides: int)
                    (firstIndicesBuffer: ClArray<int>)
                    (firstValuesBuffer: ClArray<'a>)
                    (secondIndicesBuffer: ClArray<int>)
                    (secondValuesBuffer: ClArray<'b>)
                    (allIndicesBuffer: ClArray<int>)
                    (firstResultValues: ClArray<'a>)
                    (secondResultValues: ClArray<'b>)
                    ...
                    if gid < sumOfSides then
                        ...
                        while leftEdge <= rightEdge do
                            ...
                            let secondIndex = localIndices.[firstLocalLength + lid - middleIdx]
